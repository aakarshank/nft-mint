...
export const contractAddress = "0x0DB9a637d5B7B8701E8E57Bba728eDDABcFb3626";
...
export default function Home(){
    ...
    async function connectWallet(){
        if (window.ethereum){
            try {
                ...
                document.getElementById("connectWalletButton").innerHTML = "connected";
            } catch (error) {
    ...
    function checkConnection(){
        if (document.getElementById("connectWalletButton").innerHTML == "connected"){
            
            navigate("/marketplace");
        } else {
            alert("Connect metamask wallet first")
        }
    }
